...
function SignupPage() {
    ...
    const handleSignup = async (e)=>{
        ...
        try {
            ...
            const user = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["signupUser"])(email, password, name);
            if (user) {
                setTimeout(()=>{
                    router.push("/account");
                }, 500);
